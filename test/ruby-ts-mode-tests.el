    ...
    (dolist (pair pairs)
      (let ((name  (car pair))
        ...
        (ruby-with-temp-buffer (ruby-test-string
          ...
          (search-backward "_")
          (forward-line)
          (should (string= (funcall add-log-current-defun-function)
                           (format "M::C%s" value))))))))
...
(ert-deftest ruby-add-log-current-method-outside-of-method ()
  (ruby-with-temp-buffer (ruby-test-string
                          ...
                          |end")
    (search-backward "_")
    (should (string= (funcall add-log-current-defun-function)"M::C"))))
...
(ert-deftest ruby-add-log-current-method-in-singleton-class ()
  (ruby-with-temp-buffer (ruby-test-string
                          ...
                          |end")
    (search-backward "_")
    (should (string= (funcall add-log-current-defun-function) "C.foo"))))
...
(ert-deftest ruby-add-log-current-method-namespace-shorthand ()
  (ruby-with-temp-buffer (ruby-test-string
                          ...
                          |end")
    (search-backward "_")
    (should (string= (funcall add-log-current-defun-function) "C::D#foo"))))
...
(ert-deftest ruby-add-log-current-method-after-inner-class ()
  (ruby-with-temp-buffer (ruby-test-string
                          ...
                          |end")
    (search-backward "_")
    (should (string= (funcall add-log-current-defun-function) "M::C#foo"))))
